...
def repo(update: Update, context: CallbackContext):
    button = [
    [InlineKeyboardButton("Repo", url=f"https://google.com")],
    [InlineKeyboardButton("Support Group", url=f"https://t.me/joinchat/9tt85ExroOA1NDZl")]]
...
/{BotCommands.RepoCommand}: Get the bot repo. (Useless command, I wont tell repo 😎)
