    ...
    def __onDownloadStarted(self, api, gid):
        ...
        if ENABLE_FILESIZE_LIMIT:
          if size / 1024 / 1024 / 1024 > MAX_TORRENT_SIZE:
              ...
              dl.getListener().onDownloadError(f'File size {get_readable_file_size(size)} larger than Maximum Allowed size {MAX_TORRENT_SIZE} Ask @admin if you want to download this file(s).')
        ...
        if STOP_DUPLICATE_MIRROR:
          ...
          if smsg:
              dl.getListener().onDownloadError(f' #AlreadyDownloaded 😡 File is already available in drive. You should have search before mirror any file. You might get ban if you do this again. This download has been stopped.\n\n')
