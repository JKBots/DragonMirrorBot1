...
def _watch(bot: Bot, update, isTar=False):
    ...
    try:
        ...
        msg = f"/{BotCommands.WatchCommand} [yt_dl supported link] [quality] |[CustomName] to mirror with youtube_dl. Use <code>/get ytdl_sites</code> to get list of YT-DL supported sites. <b>Note</b> : Some sites won't work which require authentication.\n\n"
        ...
        msg += f"\n\nExample :-\n<code>/{BotCommands.WatchCommand} https://youtu.be/QUPMjiDHP5w 720 |@DragonMirror.mp4</code>\n\n"
        msg += "This file will be downloaded in 720p quality and it's name will be <b>@DragonMirror.mp4</b>"
